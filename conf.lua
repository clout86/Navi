function love.conf(t)
  t.identity = "navi"                   -- The name of the save directory (string)
  ...
  t.window.title = "Navi"               -- The window title (string)
  t.window.icon = "assets/Dawindo.png"  -- Filepath to an image to use as the window's icon (string)
